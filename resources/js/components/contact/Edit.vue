    ...
    <div>
        ...
        <b-form @submit.prevent="onSubmit" @reset="onReset" class="p-5">
            ...
            <b-form-group id="zip_code" label="Zip Code:" label-for="zip_code">
                <b-form-input id="zip_code" v-model="form.zip_code"  placeholder="Enter zip code"></b-form-input>
            </b-form-group>
            ...
            <b-form-group id="company" label="Company Name:" label-for="company">
                <b-form-input id="company" v-model="form.company"  placeholder="Enter company name"></b-form-input>
            </b-form-group>
            <b-form-group id="mark" label="Mark Name:" label-for="mark">
                <b-form-input id="mark" v-model="form.mark"  placeholder="Enter mark name"></b-form-input>
            </b-form-group>
            <b-form-group id="siret" label="Siret Number:" label-for="siret">
                <b-form-input id="siret" v-model="form.siret"  placeholder="Enter siret number"></b-form-input>
            </b-form-group>
            <b-form-group id="kbis" label="KBIS number:" label-for="kbis">
                <b-form-input id="kbis" v-model="form.kbis"  placeholder="Enter KBIS number"></b-form-input>
            </b-form-group>
            ...
            <b-form-group id="origin" label="Origin Of Contact:" label-for="origin">
                <b-form-input id="status" v-model="form.origin"  placeholder="Enter origin"></b-form-input>
            </b-form-group>
